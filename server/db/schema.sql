...
INSERT INTO neighborhoods (name, lat, lng) VALUES
  ('Adlershof',          52.4340, 13.5328),
  ('Britz',              52.4607, 13.4390),
  ('Charlottenburg',     52.5168, 13.3044),
  ('Dahlem',             52.4522, 13.2951),
  ('Friedenau',          52.4698, 13.3534),
  ('Friedrichshain',     52.5153, 13.4534),
  ('Grunewald',          52.4773, 13.2672),
  ('Hellersdorf',        52.5264, 13.6012),
  ('Hohenschönhausen',   52.5582, 13.5003),
  ('Karlshorst',         52.4872, 13.5298),
  ('Köpenick',           52.4547, 13.5806),
  ('Kreuzberg',          52.4987, 13.4043),
  ('Lankwitz',           52.4389, 13.3562),
  ('Lichtenberg',        52.5118, 13.5028),
  ('Lichterfelde',       52.4337, 13.3197),
  ('Mariendorf',         52.4601, 13.3855),
  ('Marienfelde',        52.4213, 13.3652),
